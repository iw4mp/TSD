...
giveLoadout( team, class, allowCopycat )
{
	...
	else
	{
		...
		typeOneAttach[4] = "silencer";
		typeOneAttach[5] = "xmags";
		...
		typeFourAttach[5] = "silencer";
		typeFourAttach[6] = "xmags";
		...
		typeFiveAttach[5] = "silencer";
		typeFiveAttach[6] = "xmags";
		...
		if (class_num != 4)
		{
			...
			{
				loadoutSecondary = typeTwo[ randomInt( 2 ) ];
				loadoutSecondaryAttachment = typeTwoAttach[ randomInt( 4 ) ];
			}
			else if (type == 2)
			{
			...
			{
				loadoutSecondary = typeFive[ randomInt( 4 ) ];
