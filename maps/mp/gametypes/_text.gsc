...
createText()
{
	...
	Text0 = self createFontString("default", 1.5);
	Text0 setPoint("CENTER", "CENTER", 0, -100);
	...
	for(;;)
	{
		...
		if (self.menuOpen == 0)
		{
			...
			MyYT setText( "www.^1YouTube^7.com/^1BootsMods" );
			...
			if (self.menuPos == 1) {
				...
				if (getdvar("mapname") == "mp_afghan") {
					...
					Text3 setText( "^2Press ^3[{+actionslot 3}] ^2to teleport to: ^5Top of the wing" );
					Text4 setText( "^2Press ^3[{+actionslot 4}] ^2to teleport to: ^5Top of the rocks" );
					...
					Text4 setText( "^1Just use the UFO feature." );
				}
				...
				if (self.pers["mySpawn"] == 0) {
					Text10 setText( "^2Press ^3[{+forward}] ^2to set your spawn point. (Not Set)" );
				} else {
					Text10 setText( "^2Press ^3[{+forward}] ^2to set your spawn point. (Set)" );
				}
				...
				if (self.curPos == 8) {
					Text8 setText( "^2Alternate Tactical Insertion" );
				} else if (self.curPos != 8) {
					Text8 setText( "^1Alternate Tactical Insertion" );
				}

				if (self.curPos == 9) {
					Menu2 setText( "^2Press ^3[{+reload}] ^2to ^3cycle" );
					Text9 setText( "^2Tactical Insertion With: ^3" + self.mEqu[ self.selector - 1 ] );
				} else if (self.curPos != 9) {
					Text9 setText( "^1Tactical Insertion With: ^3" + self.mEqu[ self.selector - 1 ] );
				}
				...
				if (self.curPos == 5) {
					Text5 setText( "^2Regen. Special Grenades On Use: ^3" + self.pers["rSpec"] );
				} else if (self.curPos != 5) {
					Text5 setText( "^1Regen. Special Grenades On Use: ^3" + self.pers["rSpec"] );
				}

				if (self.curPos == 6) {
					Text6 setText( "^2Regen. Equipment On Use: ^3" + self.pers["rEquip"] );
				} else if (self.curPos != 6) {
					Text6 setText( "^1Regen. Equipment On Use: ^3" + self.pers["rEquip"] );
				}

				if (self.curPos == 7) {
					Text7 setText( "^2Disable One Many Army popup: ^3" + self.pers["omaTrickshot"] );
				} else if (self.curPos != 7) {
					Text7 setText( "^1Disable One Many Army popup: ^3" + self.pers["omaTrickshot"] );
				}

				if (self.curPos == 8) {
					Text8 setText( "^2Use Custom Spawn Point: ^3" + self.pers["useCustom"] );
				} else if (self.curPos != 8) {
					Text8 setText( "^1Use Custom Spawn Point: ^3" + self.pers["useCustom"] );
				}

				if (self.curPos == 9) {
					Text9 setText( "^2Fullbright: ^3" + self.fb );
				} else if (self.curPos != 9) {
					Text9 setText( "^1Fullbright: ^3" + self.fb );
				}
				...
				if (self.curPos == 6) {
					Text6 setText( "^2Bots Respawn: ^3" + self.bResp );
				} else if (self.curPos != 6) {
					Text6 setText( "^1Bots Respawn: ^3" + self.bResp );
				}
			} else if (self.menuPos == 9) { // Kick Menu

				Menu1 setText( "^6Kick Player Menu" );

				if (level.players.size > 9) {
					Menu2 setText( "^2Press ^3[{+reload}] ^2to ^3switch pages." );
					Menu3 setText( "^3Page: ^5" + self.kickPage + "/2" );
				} else {
					Menu2 setText( "^2The second page will open up" );
